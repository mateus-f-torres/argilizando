...
import AbilityTable from 'Components/common/AbilityTable';
import OptionSkill from './OptionSkill';
import OptionLang from './OptionLang';
import OptionTool from './OptionTool';
import OptionEquip from './OptionEquip';
import OptionBody from './OptionBody';
import OptionPast from './OptionPast';
