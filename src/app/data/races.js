    ...
    [
      ...
      },
      {
        ...
        special: [
          [
            "False Appearance",
            "While you aren't using any of your other race traits you can contain your celestial heritage to appear indistinguishable from a normal human."
          ],
          [
            "Healing Hands",
      ...
      },
      {
        ...
        special: [
          [
            "False Appearance",
            "While you aren't using any of your other race traits you can contain your fiendish heritage to appear indistinguishable from a normal human."
          ],
          [
            "Cursed Hands",
    ...
    [
      ...
      },
      {
        ...
        special: [
          ...
          [
            "Tinker",
            "You have proficiency with tinker's tools. Using those tools, you can spend time and materials working on projects to create clockwork mechanisms. The time spend and material cost is always proportional to the scope of the project."
          ]
        ]
      },
      {
