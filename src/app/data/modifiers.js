export default {
  ...
  str: [
    ...
    [-3,
      `Visibly weak. Might be knocked off balance 
      by swinging something dense`],
    [-2,
      `Difficulty pushing an object of their weight`],
    [-1,
      `Has trouble lifting heavy objects for a longer time`],
    [0,
      `Lifts heavy objects for a short time. 
      Can perform simple physical labor for a few hours without break`],
    [1,
      `Carries heavy objects and throws small objects for medium distances. 
      Can perform physical labor for half a day without break`],
    [2,
      `Visibly toned. Carries heavy objects with one arm for longer distances. 
      Doesn't get too exhausted by physical labor`],
    [3,
      `Muscular. Can break objects like wood with bare hands and raw strength. 
      Can perform heavy physical labor for several hours without break`],
    [4,
      `Heavily muscular. Able to out-wrestle a work animal or 
  ...
  int: [
    [-5,
      ...
      Behavior is reduced to simple reactions to immediate stimuli`],
    [-4,
      `Rather animalistic. Acts on instinct but 
      can still resort to simple planning and tactics`],
    [-3,
      `Very limited speech and knowledge. 
      Often resorts to charades to express thoughts`],
    [-2,
      `Has trouble following trains of thought, 
      forgets most unimportant things`],
    [-1,
    ...
    [2,
      ...
      Able to do math or solve logic puzzles mentally 
  ...
  cha: [
    [-5,
      `Barely conscious, probably acts very alien. 
      May have a presence which repels other people.`],
    [-4,
      `Minimal independent thought, 
      relies heavily on others to think instead`],
    [-3,
    ...
    [-1,
      `Something of a bore, makes people mildly uncomfortable 
      or simply clumsy in conversation`],
    [0,
      `Capable of polite conversation`],
    [1,
      `Mildly interesting. Knows what to say to the right people`],
    [2,
      `Often popular or infamous. Knows what to say to most people 
      and is very confident in debate`],
    [3,
      `Quickly likeable, respected or feared by many people. 
      May be very eloquent. 
      Good at getting their will when talking to people`],
    [4,
      `Quickly likeable, respected or feared by almost everybody. 
      Can entertain people easily or knows how to effectively 
